...
export type DateTimeProps = {
  ...
  slideChangeCallback?: (direction: string, status?: string) => void;
...
> {
  ...
  // 滑动方向改变
  slideChange = (direction: string, status?: string) => {
    const { slideChangeCallback } = this.props;
    slideChangeCallback && slideChangeCallback(direction, status);
  };
